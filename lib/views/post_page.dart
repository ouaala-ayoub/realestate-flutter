...
class _PostPageState extends State<PostPage> {
  ...
  Widget build(BuildContext context) {
    return Consumer<PostPageProvider>(
            ...
            child: SafeArea(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(
                    child: textIconRow(
                          ...
                          builder: (context, provider, _) => loading
                              ...
                              : provider.loading
                                  ...
                                  : provider.auth!.fold((l) {
                                      ...
                                      (user) => user.likes?.contains(post.id) ==
                                              true
                                          ? const Icon(
                      ...
                      () {
                        loading
                            ? logger.i('loading')
                            : context.read<RealestateAuthProvider>().auth!.fold(
                                (l) {
                                logger.i('you need to login first');
                  ...
                  const SliverToBoxAdapter(child: TitleWidget(text: 'More :')),
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Consumer<PostPageProvider>(
                        builder: (context, provider, consumerWidget) => provider
                                .loading
                            ? const Center(
                                child: CupertinoActivityIndicator(),
                              )
